...
Declaración de adopción AOS para `anclora-group`.

## Metadatos

- Repository Name: anclora-group
...
`anclora-group` forma parte del ecosistema Anclora como aplicación operativa Next.js.
